...
Then population size in each timestep is a function of the population size at the time before ($N_t$), the population growth rate ($r$), and the carrying capacity ($K$) as shown in the equation below.
...
inputPanel(
  ...
  sliderInput("lambda", label = "Population Growth Rate:",
              min = -.2, max = 3.2, value = 1.0, step = 0.2),

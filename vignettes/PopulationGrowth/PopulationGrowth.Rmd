...
renderPlot({
  ...
  plot(Nvec~time, ylab="Number of individuals (N)", ylim=c(input$N02,max(Nvec)), type="o")
...
```{r, echo=TRUE, fig.show='hide'}
  ...
  plot(Nvec~time, ylab="Number of individuals (N)", ylim=c(N0,max(Nvec)), type="o")  #plot the results

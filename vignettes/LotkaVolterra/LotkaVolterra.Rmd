...
### 1. Given that $\alpha_{11} = 0.3$ and $\alpha_{22} = 0.2$, choose interspecific competition coefficients that result in species 1 going extinct.
```{r, echo=FALSE, message=FALSE, warning=FALSE}
shinyAppDir(
...
### 2. Choose competition coefficients that result in species 2 going extinct.
```{r, echo=FALSE, message=FALSE, warning=FALSE}
shinyAppDir(
  system.file("examples/LV2", package="EcoEvoApps"),
  options=list(
...
### 3. Choose competition coefficients that result in species coexistence.
```{r, echo=FALSE, message=FALSE, warning=FALSE}
shinyAppDir(
  system.file("examples/LV2", package="EcoEvoApps"),
  options=list(

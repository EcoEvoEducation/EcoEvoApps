...
g1 <- ggplot(df, aes(x=N, y=r)) +
  ...
  ggtitle("Fig. 1: Per capita growth rate decreases\nas linear function of population density") +
  my_theme
...
g2 <- ggplot(df, aes(x=N, y=rpop)) +
  ...
  ggtitle("Fig. 1: Population growth rate increases and\nthen decreases as a function of population density") +
  my_theme
...
To include the effect of another species, we assume that growth is further limited by a simple function of the number of the other species, $\alpha_{ij}Nj$, where $\alpha_{ij} reads as: "the effect of species *j* on species *i*". Putting it all together 

...
To include the effect of another species, we assume that growth is further limited by a simple function of the number of the other species, $\alpha_{2,1}N_2$.
